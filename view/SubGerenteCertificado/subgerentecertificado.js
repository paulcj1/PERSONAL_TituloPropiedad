...
$('#certificados_data').DataTable({
    ...
    "ajax":{
        url:"../../controller/certificado.php?op=listar_certificados_pendiente_subgerente",
        type:"post"
    },
    "bDestroy": true,
    "responsive": false,
...
function firmar(cert_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.post("../../controller/certificado.php?op=cambiar_estfirmado2", { cert_id: cert_id })
                .done(function() {
...
function imp_masivo(){
    ...
    redirect_by_post(
        "../../controller/certificado.php?op=imprimir_x_firm1"
...
function total_certificados_pendientes(){
    $.post("../../controller/certificado.php?op=total_pendientes_subgerente", function (data) {
...
function total_certificados_descargables(){
    $.post("../../controller/certificado.php?op=total_descargables_subgerente", function (data) {
