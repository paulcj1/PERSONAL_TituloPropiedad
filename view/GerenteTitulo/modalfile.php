    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content bd-0">
            ...
            <form method="post" id="adjuntar_form" enctype="multipart/form-data">
                <input type="hidden" name="titux_idx" id="titux_idx"/>

                <div class="modal-body">
                    <div class="col-lg-12">
                        <div class="form-group">
                        <input type="file" id="titu_firmapdf" name="titu_firmapdf" accept=".pdf" required data-parsley-required-message="Por favor, adjunte un archivo PDF."/>
                        </div>
                    </div>
                </div>
