...
$('#titulos_data').DataTable({
    ...
    "ajax":{
        url:"../../controller/titulo.php?op=listar_titulos_pendiente_subgerente",
        type:"post"
    },
    "bDestroy": true,
    "responsive": false,
...
function firmar(titu_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.post("../../controller/titulo.php?op=cambiar_estfirmado2", { titu_id: titu_id })
                .done(function() {
...
function imp_masivo(){
    ...
    redirect_by_post(
        "../../controller/titulo.php?op=imprimir_x_firm1"
...
function total_titulos_pendientes(){
    $.post("../../controller/titulo.php?op=total_pendientes_subgerente", function (data) {
...
function total_titulos_descargables(){
    $.post("../../controller/titulo.php?op=total_descargables_subgerente", function (data) {
