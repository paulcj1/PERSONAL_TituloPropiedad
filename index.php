      ...
      <form action="" method="post">
        <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white rounded shadow-base">
          ...
          ?>
            ...
            <div class="tx-center mg-b-30">Titulos</div>
            
            <div class="form-group">
                <input type="text" id="usua_correo" name="usua_correo" class="form-control" placeholder="Ingrese Correo Electronico">
            </div>
            <div class="form-group">
                <input type="password" id="usua_pass" name="usua_pass" class="form-control" placeholder="Ingrese contraseña">
            </div>
